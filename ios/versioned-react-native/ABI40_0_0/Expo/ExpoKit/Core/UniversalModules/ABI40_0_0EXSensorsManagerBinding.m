...
- (instancetype)initWithExperienceScopeKey:(NSString *)experienceScopeKey andKernelService:(id<ABI40_0_0EXSensorsManagerBindingDelegate>)kernelService
{
  if (self = [super init]) {
...
+ (const NSArray<Protocol *> *)exportedInterfaces {
  return @[@protocol(ABI40_0_0UMAccelerometerInterface), @protocol(ABI40_0_0UMBarometerInterface),  @protocol(ABI40_0_0UMDeviceMotionInterface), @protocol(ABI40_0_0UMGyroscopeInterface), @protocol(ABI40_0_0UMMagnetometerInterface), @protocol(ABI40_0_0UMMagnetometerUncalibratedInterface)];
}
