...
#import "ABI40_0_0EXNotifications.h"
...
@interface ABI40_0_0EXNotifications ()

// unversioned ABI40_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI40_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI40_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI40_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI40_0_0EXNotifications

ABI40_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
ABI40_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI40_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI40_0_0UMModuleRegistryHolderReactModule class]] moduleRegistry] getModuleImplementingProtocol:@protocol(ABI40_0_0UMConstantsInterface)];
...
ABI40_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
...
ABI40_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI40_0_0RCTPromiseRejectBlock)reject)
{
  ...
  ABI40_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI40_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI40_0_0RCTPromiseRejectBlock)reject)
{
...
ABI40_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI40_0_0RCTPromiseRejectBlock)reject)
{
...
ABI40_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI40_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.repeatInterval = [ABI40_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI40_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI40_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI40_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI40_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI40_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI40_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI40_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI40_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
...
ABI40_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI40_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI40_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI40_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI40_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI40_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI40_0_0RCTPromiseRejectBlock)reject)
{
  [ABI40_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI40_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI40_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI40_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI40_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
