...
+ (const NSArray<Protocol *> *)exportedInterfaces {
  return @[@protocol(ABI41_0_0UMAccelerometerInterface), @protocol(ABI41_0_0UMBarometerInterface),  @protocol(ABI41_0_0UMDeviceMotionInterface), @protocol(ABI41_0_0UMGyroscopeInterface), @protocol(ABI41_0_0UMMagnetometerInterface), @protocol(ABI41_0_0UMMagnetometerUncalibratedInterface)];
}
