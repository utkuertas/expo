...
@class ABI41_0_0RNCWebView;

@protocol ABI41_0_0RNCWebViewDelegate <NSObject>

- (BOOL)webView:(ABI41_0_0RNCWebView *_Nonnull)webView
   shouldStartLoadForRequest:(NSMutableDictionary<NSString *, id> *_Nonnull)request
   withCallback:(ABI41_0_0RCTDirectEventBlock _Nonnull)callback;

@end

@interface ABI41_0_0RNCWeakScriptMessageDelegate : NSObject<WKScriptMessageHandler>
