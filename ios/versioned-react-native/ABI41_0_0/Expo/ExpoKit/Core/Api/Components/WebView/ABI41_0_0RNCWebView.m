...
@implementation ABI41_0_0RNCWebView
{
  ...
  // https://github.com/ABI41_0_0React-native-webview/ABI41_0_0React-native-webview/issues/62
...
- (void)setMessagingEnabled:(BOOL)messagingEnabled {
  ...
  [
   ...
   injectionTime:WKUserScriptInjectionTimeAtDocumentStart
   /* TODO: For a separate (minor) PR: use logic like this (as ABI41_0_0React-native-wkwebview does) so that messaging can be used in all frames if desired.
