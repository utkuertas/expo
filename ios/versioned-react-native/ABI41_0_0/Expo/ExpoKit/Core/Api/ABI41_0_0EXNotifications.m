...
#import "ABI41_0_0EXNotifications.h"
...
@implementation ABI41_0_0RCTConvert (NSCalendarUnit)

ABI41_0_0RCT_ENUM_CONVERTER(NSCalendarUnit,
                   (@{
...
@interface ABI41_0_0EXNotifications ()

// unversioned ABI41_0_0EXRemoteNotificationManager instance
@property (nonatomic, weak) id <ABI41_0_0EXNotificationsScopedModuleDelegate> remoteNotificationsDelegate;
@property (nonatomic, weak) id <ABI41_0_0EXNotificationsIdentifiersManager> notificationsIdentifiersManager;
@property (nonatomic, weak) id <ABI41_0_0EXUserNotificationCenterService> userNotificationCenter;

@end

@implementation ABI41_0_0EXNotifications

ABI41_0_0EX_EXPORT_SCOPED_MULTISERVICE_MODULE(ExponentNotifications, @"RemoteNotificationManager", @"UserNotificationManager", @"UserNotificationCenter");
...
{
  if (self = [super initWithExperienceStableLegacyId:experienceStableLegacyId experienceScopeKey:experienceScopeKey kernelServiceDelegate:kernelServiceInstances params:params]) {
...
ABI41_0_0RCT_REMAP_METHOD(getDevicePushTokenAsync,
...
{
  ABI41_0_0EXConstantsBinding *constants = [[[self.bridge moduleForClass:[ABI41_0_0UMModuleRegistryHolderReactModule class]] umModuleRegistry] getModuleImplementingProtocol:@protocol(ABI41_0_0UMConstantsInterface)];
...
ABI41_0_0RCT_REMAP_METHOD(getExponentPushTokenAsync,
...
ABI41_0_0RCT_EXPORT_METHOD(presentLocalNotification:(NSDictionary *)payload
                  resolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI41_0_0RCTPromiseRejectBlock)reject)
{
  if (!payload[@"data"]) {
  ...
  ABI41_0_0RCT_EXPORT_METHOD(scheduleNotificationWithTimer:(NSDictionary *)payload
...
ABI41_0_0RCT_EXPORT_METHOD(scheduleNotificationWithCalendar:(NSDictionary *)payload
                 withOptions:(NSDictionary *)options
                 resolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
...
ABI41_0_0RCT_EXPORT_METHOD(scheduleLocalNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
...
ABI41_0_0RCT_EXPORT_METHOD(legacyScheduleLocalRepeatingNotification:(NSDictionary *)payload
                  withOptions:(NSDictionary *)options
                  resolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
  ...
  localNotification.userInfo = @{
                                 @"body": payload[@"data"],
                                 @"experienceId": self.experienceScopeKey,
                                 @"scopeKey": self.experienceScopeKey,
                                 @"id": uniqueId
                                 };
  localNotification.fireDate = [ABI41_0_0RCTConvert NSDate:options[@"time"]] ?: [NSDate new];
  localNotification.repeatInterval = [ABI41_0_0RCTConvert NSCalendarUnit:options[@"repeat"]] ?: 0;

  __weak typeof(self) weakSelf = self;
  [ABI41_0_0EXUtil performSynchronouslyOnMainThread:^{
    [ABI41_0_0RCTSharedApplication() scheduleLocalNotification:localNotification];
...
ABI41_0_0RCT_REMAP_METHOD(cancelScheduledNotificationAsync,
                 cancelScheduledNotificationAsync:(NSString *)uniqueId
                 withResolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI41_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
...
ABI41_0_0RCT_REMAP_METHOD(cancelAllScheduledNotificationsAsync,
                 cancelAllScheduledNotificationsAsyncWithResolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(__unused ABI41_0_0RCTPromiseRejectBlock)reject)
{
  __weak id<ABI41_0_0EXUserNotificationCenterService> userNotificationCenter = _userNotificationCenter;
  [_userNotificationCenter getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
    ...
    for (UNNotificationRequest *request in requests) {
      if ([request.content.userInfo[@"experienceId"] isEqualToString:self.experienceScopeKey]) {
...
ABI41_0_0RCT_REMAP_METHOD(getBadgeNumberAsync,
                 getBadgeNumberAsyncWithResolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                 rejecter:(ABI41_0_0RCTPromiseRejectBlock)reject)
{
  __block NSInteger badgeNumber;
  [ABI41_0_0EXUtil performSynchronouslyOnMainThread:^{
    badgeNumber = ABI41_0_0RCTSharedApplication().applicationIconBadgeNumber;
  }];
  resolve(@(badgeNumber));
}

ABI41_0_0RCT_EXPORT_METHOD(setBadgeNumberAsync:(nonnull NSNumber *)number
                  resolver:(ABI41_0_0RCTPromiseResolveBlock)resolve
                  rejecter:(__unused ABI41_0_0RCTPromiseRejectBlock)reject)
{
  [ABI41_0_0EXUtil performSynchronouslyOnMainThread:^{
    ABI41_0_0RCTSharedApplication().applicationIconBadgeNumber = number.integerValue;
  }];
  resolve(nil);
}
...
ABI41_0_0RCT_REMAP_METHOD(createCategoryAsync,
...
ABI41_0_0RCT_REMAP_METHOD(deleteCategoryAsync,
...
- (NSString *)internalIdForIdentifier:(NSString *)identifier {
  return [_notificationsIdentifiersManager internalIdForIdentifier:identifier experienceScopeKey:self.experienceScopeKey];
}
...
- (NSDateComponents *)dateComponentsFrom:(NSNumber * _Nullable)unixTime {
  ...
  NSDate *triggerDate = [ABI41_0_0RCTConvert NSDate:unixTime] ?: [NSDate new];
