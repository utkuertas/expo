...
@protocol ABI41_0_0EXUserNotificationCenterService
...
@protocol ABI41_0_0EXNotificationsScopedModuleDelegate
...
- (NSString *)internalIdForIdentifier:(NSString *)identifier experienceScopeKey:(NSString *)experienceScopeKey;
- (NSString *)exportedIdForInternalIdentifier:(NSString *)identifier;

@end

@interface ABI41_0_0EXNotifications : ABI41_0_0EXScopedBridgeModule
