...
- (instancetype)initWithExperienceStableLegacyId:(NSString *)experienceStableLegacyId experienceScopeKey:(NSString *)experienceScopeKey kernelServiceDelegate:(id<ABI41_0_0EXUtilService>)kernelServiceInstance params:(NSDictionary *)params
{
