...
- (void)switchTasks;
- (void)reloadAppWithExperienceScopeKey:(NSString *)experienceScopeKey; // called by Updates.reload
- (void)reloadAppFromCacheWithExperienceScopeKey:(NSString *)experienceScopeKey; // called by Updates.reloadFromCache
